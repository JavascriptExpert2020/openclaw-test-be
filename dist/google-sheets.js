...
const getSheetsConfig = () => {
    ...
    if (!clientEmail || !privateKeyRaw || !spreadsheetId) {
        throw new Error("Missing Google Sheets config. Set GOOGLE_SHEETS_CLIENT_EMAIL, GOOGLE_SHEETS_PRIVATE_KEY, and GOOGLE_SHEETS_SPREADSHEET_ID.");
    }
...
export const appendReceiptRow = async (row) => {
